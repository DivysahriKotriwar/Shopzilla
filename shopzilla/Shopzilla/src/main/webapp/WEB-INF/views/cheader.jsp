...
<head>
	...
	<link rel="icon" href="/images/shopzilla1.png" />
		<link rel="icon" href="/images/bc2.png" />
</head>
<body>
	<div class="container-fluid">
		<div class="header">
			...
			<div class="position-absolute w-100" style="top:50px">
				...
				<div class="logo">
					<a href="/"><img style="width: 300px; height: 100px;"
						src="/images/bc2.png" alt="" /></a>
				</div>
				
					<div class="logos">
					<a href="/"><img style="width: 220px; height: 100px;"
						src="/images/shopzilla1.png" alt="" /></a>
				</div>
