...
<div class="main">
    <div class="content">
        <div class="login_panel" style="width: 500px;">
            <h3>Existing Customers</h3>
            <p>Sign in with the form below.</p>
            <form method="post" autocomplete="off">
                <input name="userid" type="text" placeholder="User ID">
                <input name="pwd" type="password" placeholder="Password">                
                <div class="buttons"><div><button class="green">Sign In</button></div></div>
                <jsp:include page="msg.jsp"></jsp:include>
            </form>
        </div>
        <div class="register_account" style="width:700px;">
            <img src="images/shop1.png" class="img-thumbnail float-right">
